...
const config: Config = {
  ...
  testMatch: [
    ...
    '**/src/__tests__/SailorList.sort.test.jsx',
    ...
    '**/src/__tests__/HeatRaceHandler.transferBoat.test.ts',
    '**/src/__tests__/HeatRaceHandler.updateRaceResult.test.ts',
    '**/src/__tests__/HeatRaceHandler.insertRaceDefaults.test.ts',
    '**/src/__tests__/HeatComponent.finalAssignment.test.jsx',
    ...
    '**/src/__tests__/HeatRaceHandler.submitScoresAtomic.test.ts',
